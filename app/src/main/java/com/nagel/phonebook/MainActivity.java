...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        menu.add(Menu.NONE, MENU_SHOW, Menu.NONE, getString(R.string.menuShow));
        menu.add(Menu.NONE, MENU_CREATE, Menu.NONE, getString(R.string.menuCreate));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add(Menu.NONE, MENU_SEARCH, Menu.NONE, getString(R.string.menuSearch));
        //menu.add(Menu.NONE, MENU_CREATE, Menu.NONE, getString(R.string.menuCreate));
